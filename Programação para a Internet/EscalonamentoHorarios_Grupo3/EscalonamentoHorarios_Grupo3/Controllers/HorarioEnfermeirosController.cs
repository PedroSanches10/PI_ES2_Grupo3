...
namespace EscalonamentoHorarios_Grupo3.Controllers
{
    public class HorarioEnfermeirosController : Controller
    {
        ...
        public HorarioEnfermeirosController(EscalonamentoHorarios_Grupo3DbContext context)
        {
            _context = context;
        }
        ...
        {
            var escalonamentoHorarios_Grupo3DbContext = _context.HorariosEnfermeiro.Include(h => h.Enfermeiro).Include(h => h.Turno);
            return View(await escalonamentoHorarios_Grupo3DbContext.ToListAsync());
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TurnoId"] = new SelectList(_context.Set<Turno>(), "TurnoId", "TurnoId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("HorarioEnfermeiroId,DataInicioTurno,Duracao,DataFimTurno,TurnoId,EnfermeiroId")] HorarioEnfermeiro horarioEnfermeiro)
        {
            ...
            ViewData["TurnoId"] = new SelectList(_context.Set<Turno>(), "TurnoId", "TurnoId", horarioEnfermeiro.TurnoId);
            return View(horarioEnfermeiro);
        }
